...
namespace TalkingCardAPI
{
            ...
            face.emotionSprites = new List<CharacterFace.EmotionSprites>
             {
                new CharacterFace.EmotionSprites
                {
                    ...
                    eyesClosed = AssetHelpers.MakeSprite(Properties.Resources.Possum_Eyes_Closed),
                    
                    //Initialises the Texture of the card's emission.
                    eyesOpenEmission = AssetHelpers.MakeSprite(Properties.Resources.Possum_Eyes_Emission),
                    ...
                    mouthOpen = AssetHelpers.MakeSprite(Properties.Resources.Possum_Mouth_Open),
                }};
    ...
    public class CustomStoatTalker : PaperTalkingCard
    {
        ...
        public override string OnSacrificedDialogueId => "CustomStoatSacrificed";
        ...
        public override string OnSelectedForCardRemoveDialogueId => "CustomStoatSelectableBad";

        //The dialogue event for when the card is given a sigil at the sacrifice stones.
        public override string OnSelectedForCardMergeDialogueId => "CustomStoatGivenSigil";

        //The dialogue event for when the card is drawn in a deck trial.
        public override string OnSelectedForDeckTrialDialogueId => "CustomStoatTrial";
